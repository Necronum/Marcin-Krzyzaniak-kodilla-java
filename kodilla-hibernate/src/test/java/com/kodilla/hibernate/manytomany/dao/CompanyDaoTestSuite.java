...
class CompanyDaoTestSuite {
    ...
    void testCompanyQuery(){
        ...
        //When
        String companySubstring1 = "Sof";
        List<Company> companyName1 = companyDao.retrieveCompanyNameBySubstring(companySubstring1);
        String companySubstring2 = "Dat";
        List<Company> companyName2 = companyDao.retrieveCompanyNameBySubstring(companySubstring2);
        String companySubstring3 = "Gre";
        List<Company> companyName3 = companyDao.retrieveCompanyNameBySubstring(companySubstring3);
